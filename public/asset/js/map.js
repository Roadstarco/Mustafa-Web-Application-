...
AutocompleteDirectionsHandler.prototype.route = function() {
    var polylineData = document.getElementById('polyline_data');
    ...
    this.directionsService.route({
        ...
        var polyline_data = response.routes[0].overview_polyline;
        console.log("polyline_data is");
        console.log(polyline_data);
        polylineData.value=polyline_data
