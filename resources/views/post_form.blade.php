...
@section('title', 'Post Trip')
@section('description', 'Post your trip and wait for a traveler to pick you. Enter details of your package, mode of transportation, date and time.')
...
<form action="{{route('trips.index')}}" method="post" id="travel-form" class="form-horizontal">
<fieldset>
<div class="row">
<div class="col-md-12">
...
<input type="radio" id="travel_form_type_recurrence_placeholder" name="recurrence" value="" checked="checked" />
Never</label>
</div>
<div class="radio">
...
<option value="xl" selected="selected">Extra large</option>
</select>
</div>
</div>
<div class="form-group">
