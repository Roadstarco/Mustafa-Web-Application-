    ...
    <div class="dash-content">
        ...
        <div class="row no-margin">
            <form>
                ...
                <div class="col-md-6 pro-form">
                    <h5 class="col-md-6 no-padding"><strong>@lang('user.profile.country')</strong></h5>
                    <p class="col-md-6 no-padding">{{Auth::user()->country_name}}</p>
                </div>

                <div class="col-md-6 pro-form">
                    <h5 class="col-md-6 no-padding"><strong>@lang('user.profile.address')</strong></h5>
                    <p class="col-md-6 no-padding">{{Auth::user()->address}}</p>
                </div>
