    ...
    <div class="dash-content">
        ...
        <div class="row no-margin edit-pro">
            ...
            {{ csrf_field() }}
                ...
                <div class="form-group col-md-6">
                    <label>@lang('user.profile.country')</label>
                    <input type="text" class="form-control" name="country_name" placeholder="@lang('user.profile.country')" value="{{Auth::user()->country_name}}">
                </div>

                <div class="form-group col-md-6">
                    <label>@lang('user.profile.address')</label>
                    <input type="text" class="form-control" name="address" required placeholder="@lang('user.profile.address')" value="{{Auth::user()->address}}">
                </div>
