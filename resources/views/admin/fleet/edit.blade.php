...
@section('title', 'Update Company Owner ')
...
<div class="content-area py-1">
    <div class="container-fluid">
    	<div class="box box-block bg-white">
			...
			<h5 style="margin-bottom: 2em;">Update Company Owner </h5>
    ...
    <!--                @endif-->
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<button type="submit" class="btn btn-primary">Update Company Owner </button>
