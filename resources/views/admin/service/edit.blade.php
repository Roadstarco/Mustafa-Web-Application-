        ...
        <div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.service.update', $service->id )}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-10">
                        <textarea class="form-control" type="number" value="{{ $service->description }}" name="description" required id="description" placeholder="Description" rows="4">{{ $service->description }}</textarea>
                    </div>
                </div>
{{--                <div class="form-group row">--}}
{{--                    <label for="name" class="col-xs-2 col-form-label">Select Zone</label>--}}
{{--                    <div class="col-xs-10">--}}
{{--                        <div class="form-control" style="max-height: 200px; overflow-y: scroll;">--}}
{{--                            @foreach($zones as $zone)--}}
{{--                                @if( in_array($zone->id, $serviceZonesArray) )--}}
{{--                                    <input type="checkbox" name="zones[]" checked value="{{ $zone->id }}"> {{ $zone->name }}<br>--}}
{{--                                @else--}}
{{--                                    <input type="checkbox" name="zones[]" value="{{ $zone->id }}"> {{ $zone->name }}<br>--}}
{{--                                @endif--}}
{{--                            @endforeach--}}
{{--                        </div>--}}
{{--                    </div>--}}
