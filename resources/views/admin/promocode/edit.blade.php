    ...
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.promocode.update', $promocode->id )}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					<label for="discount" class="col-xs-2 col-form-label">Minimum Amount for Discount</label>
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ $promocode->min_amount_for_discount }}" name="min_amount_for_discount" required id="min_amount_for_discount" placeholder="Maximum Discount">
					</div>
				</div>
				<div class="form-group row">
					<label for="discount" class="col-xs-2 col-form-label">Maximum Amount for Discount</label>
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ $promocode->max_amount_for_discount }}" name="max_amount_for_discount" required id="max_amount_for_discount" placeholder="Maximum Discount">
					</div>
				</div>
				<div class="form-group row">
					<label for="discount" class="col-xs-2 col-form-label">Max Usage By User</label>
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ $promocode->max_usage_by_user }}" name="max_usage_by_user" required id="max_usage_by_user" placeholder="Max Usage By User">
					</div>
				</div>
