    	...
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('admin.promocode.store')}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ old('min_amount_for_discount') }}" name="min_amount_for_discount" required id="min_amount_for_discount" placeholder="Maximum Discount">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ old('max_amount_for_discount') }}" name="max_amount_for_discount" required id="max_amount_for_discount" placeholder="Maximum Discount">
					</div>
				</div>
				...
				<div class="form-group row">
					...
					<div class="col-xs-10">
						<input class="form-control" type="number" value="{{ old('max_usage_by_user') }}" name="max_usage_by_user" required id="max_usage_by_user" placeholder="Max Usage By User">
					</div>
				</div>
				<div class="form-group row">
