		...
		<ul class="sidebar-menu">
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					...
					<span class="s-text">Company Owner</span>
				</a>
				<ul>
					<li><a href="{{ route('admin.fleet.index') }}">Owner's List </a></li>
					<li><a href="{{ route('admin.fleet.create') }}">Add New owner</a></li>
				</ul>
			</li>
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					<span class="s-caret"><i class="fa fa-angle-down"></i></span>
					<span class="s-icon"><i class="ti-save"></i></span>
...
{{--					<span class="s-text">@lang('admin.include.zones')</span>--}}
{{--				</a>--}}
{{--				<ul>--}}
{{--					<li><a href="{{ route('admin.zones.index') }}">@lang('admin.include.list_zones')</a></li>--}}
{{--					<li><a href="{{ route('admin.zones.create') }}">@lang('admin.include.add_new_zones')</a></li>--}}
{{--				</ul>--}}
{{--			</li>--}}
			<li>
          ...
          <li>
				<a href="{{ route('admin.referral-code.show' , 1) }}" class="waves-effect waves-light">
					<span class="s-icon"><i class="fa fa-user-plus"></i></span>
					<span class="s-text">@lang('admin.include.referral_code')</span>
				</a>
			</li>
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
				...
				<a href="#" class="waves-effect  waves-light">
					...
					<span class="s-text">Trips Request History</span>
				</a>
				<ul>
					    <li><a href="{{ route('admin.requests.index') }}" class="waves-effect  waves-light">User History</a></li>
					    <li class="with-sub"> 
					    <a href="#" class="waves-effect  waves-light" >
					        <span class="s-text">Trips History</span> 
					        <span class="s-caret" style="margin-left:10px;"><i class="fa fa-angle-down"></i>
					        </span>
					        </a>
				
					<ul>
					    <li><a href="{{ url('admin/trips','ground') }}" class="waves-effect  waves-light">Package Delivery History</a></li>
					    <li><a href="{{ url('admin/trips','air') }}" class="waves-effect  waves-light">Air Delivery History</a></li>
					    <li><a href="{{ url('admin/trips','sea') }}" class="waves-effect  waves-light">Sea Delivery History</a></li>
				    </ul>
				    </li>
				</ul>
				</li>
			...
			<li>
				<a href="{{ route('admin.support-message.index') }}" class="waves-effect  waves-light">
					<span class="s-icon"><i class="ti-infinite"></i></span>
					<span class="s-text">Support Messages</span>
				</a>
			</li>
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					...
					<span class="s-text">Rewards</span>
				</a>
				<ul>
					<li><a href="{{ route('admin.rewards.index') }}">Rewards List</a></li>
					<li><a href="{{ route('admin.reward-amount.index') }}">Rewards Amount</a></li>
				</ul>
			</li>
			...
			<li>
				<a href="{{ route('admin.privacy') }}" class="waves-effect waves-light">
					<span class="s-icon"><i class="fa fa-paperclip"></i></span>
					<span class="s-text">@lang('admin.include.privacy_policy')</span>
				</a>
			</li>
			<li>
				<a href="{{ route('admin.terms_and_conditions') }}" class="waves-effect waves-light">
