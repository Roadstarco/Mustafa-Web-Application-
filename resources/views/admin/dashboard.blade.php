    ...
    <div class="row row-md">
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					...
					<h1 class="mb-1">{{currency($revenue + $international_revenue) }}</h1>
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					<h6 class="text-uppercase mb-1">Total Rides</h6>
		...
		<div class="col-lg-3 col-md-6 col-xs-12">
			<div class="box box-block bg-white tile tile-1 mb-2">
				...
				<div class="t-content">
					...
					<h1 class="mb-1">{{$scheduled_rides + $international_scheduled_rides}}</h1>
				</div>
			</div>
		</div>
	</div>
					...
					<table class="table mb-md-0">
						...
						@foreach($rides as $index => $ride)
							<tr>
								...
								<td>
									<span class="text-muted">{{ \Carbon\Carbon::parse($ride->created_at)->diffForHumans()}}</span>
								</td>
								<td>
