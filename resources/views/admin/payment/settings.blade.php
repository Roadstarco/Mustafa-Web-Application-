                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-8">
                                <select name="currency" class="form-control" required>
                                    <option @if(Setting::get('currency') == "₦") selected @endif value="₦">Naira (₦)</option>
                                    <option @if(Setting::get('currency') == "$") selected @endif value="$">US Dollar (USD)</option>
                                    <option @if(Setting::get('currency') == "TT$") selected @endif value="TT$">Trinidadian Dollar (TTD)</option>
                                    <option @if(Setting::get('currency') == "Rs") selected @endif value="Rs"> Pakistani Rupee (PKR)</option>
