    ...
    <div class="container-fluid">
    	<div class="box box-block bg-white">
            ...
            <form class="form-horizontal" action="{{route('fleet.profile.update')}}" method="POST" enctype="multipart/form-data" role="form">
				...
				<div class="form-group row">
					<label for="company" class="col-xs-2 col-form-label"> Password</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" required name="password" value="" id="password" placeholder="Password">
					</div>
				</div>
				<div class="form-group row">
					<label for="company" class="col-xs-2 col-form-label">Re-Type Password</label>
					<div class="col-xs-10">
						<input class="form-control" type="text" required name="password" value="" id="password" placeholder="Re-type Password">
					</div>
				</div>
