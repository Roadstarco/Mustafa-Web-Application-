...
class UserRequests extends Model
{
    ...
    protected $fillable = [
        ...
        'provider_rated',
        'surge',
        'category', 'product_type', 'product_width', 'product_height','weight_unit','product_distribution', 'product_weight',  'attachment1', 'attachment2', 'attachment3', 'instruction', 'receiver_name', 'receiver_phone'
    ];
