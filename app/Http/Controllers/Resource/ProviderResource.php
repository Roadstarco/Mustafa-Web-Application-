...
class ProviderResource extends Controller
{
    ...
    public function statement($id){
        ...
        try{
            ...
            return view('admin.providers.statement', compact('rides','cancel_rides','revenue', 'Provider'))
  ...
  public function commissionDetail($id){
        try{
            ...
            return view('admin.providers.commission.commission-details', compact('Provider'));
    ...
    public function commissionPay(Request $request){
        ...
        try{
            ...
            $Provider->commission_payable -= $request->commission_amount ;
            $Provider->save();

            return back()->with('flash_success', "Commission Paid Successfully");
