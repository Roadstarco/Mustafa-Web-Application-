...
class DispatcherController extends Controller
{
            ...
            if ($request->has('provider_auto_assign')) {
                ...
                if (count($Providers) == 0) {
                    if ($request->ajax()) {
                        ...
                        return back()->with('flash_success', 'No Driver Found! Please try again.');
                    }
                }
    ...
    public function push_fcm($token,$title,$message){
        ...
        $serverKey = 'AAAAwn5TrEo:APA91bGq1rGc28UNoHHKtt3blImoomNPuKXlGUSqroeAKjix4LgoW6C5RKEMvz3mF_dDuPphIzMNIZIdMbt8emyZ7jdFhjL5OXmI5GPTEyccureEuvEwF7XvR1yOXk53KvhDZeOdeoqd';
