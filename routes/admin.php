...
Route::resource('zones', 'Resource\ZonesResource');

Route::resource('user', 'Resource\UserResource');
Route::resource('rewards', 'Resource\RewardsResource');
Route::resource('reward-amount', 'Resource\RewardsAmountResource');
Route::resource('dispatch-manager', 'Resource\DispatcherResource');
Route::resource('referral-code', 'Resource\ReferralCodeAmountResource');
...
Route::resource('support-message', 'Resource\SupportMessageResource');
...
Route::group(['as' => 'provider.'], function () {
    ...
    Route::get('provider/{id}/commission-detail', 'Resource\ProviderResource@commissionDetail')->name('commission-detail');
    Route::post('provider/commission-pay', 'Resource\ProviderResource@commissionPay')->name('commission-pay');
...
Route::get('/terms_and_conditions', 'AdminController@terms_and_conditions')->name('terms_and_conditions');
...
Route::group(['as' => 'fleet.'], function () {
Route::get('fleet/{id}/approve', 'Resource\FleetResource@approve')->name('approve');
Route::get('fleet/{id}/disapprove', 'Resource\FleetResource@disapprove')->name('disapprove');
});
...
Route::get('/trips/{service}', 'Resource\TravelResource@index');
Route::delete('/trips/destroy/{id}', 'Resource\TravelResource@destroy');
Route::get('/trips/show/{id}', 'Resource\TravelResource@show');